// This js file fetches data in set2 table from firebase database and appends to the table created in set2.html
// set2 table contains the details of tournaments played from 1991-1995
...
var userDataRef = firebase.database().ref('/set2/').once("value").then(function(snapshot) {
